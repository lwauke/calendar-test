...
const getWeather = async city => {
  ...
  const weatherRes = await fetch(
    `https://api.meteomatics.com/2022-03-21T00:00:00Z/weather_symbol_1h:idx/50,10/json`,
    {
      headers: new Headers({
        Authorization: 'Basic bHVjYXN3YXVrZXNlcnZpY29zZGVpbmZvcm1hdGljYV93YXVrZTplOGlqNTVUMUxO'
      })
    }
  )
  ...
  const code = weather
    ? weather.data[0].coordinates[0].dates[0].value
    : '0';
